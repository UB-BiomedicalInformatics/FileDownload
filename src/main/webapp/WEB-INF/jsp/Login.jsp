...
<body>
	<img class="print" align="right" style="padding-right:39px;" src="./images/logo.png"
		width="400" height="67" />
	<h1>
		<font size="6" class="div" color="cornsilk" style="padding-left:40px;">IRB Download Login</font>
	...
	<a href="/FileDownload/LogoutServlet" style="float: top;padding-left: 1400px;"><font
