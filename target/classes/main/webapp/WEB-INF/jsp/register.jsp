...
<jsp:useBean id="registrationUsernameErr" scope="session"
	class="java.lang.String" />
...
<body>
	...
	<h1>
		<font size="6" class="div" color="cornsilk"
			style="padding-left: 40px;">IRB Download Registration</font>
	...
	<script type="text/javascript">
		...
		function checkFormForUserName() {
			re = /[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.(?:[A-Za-z]{2}|edu|gov)/;
			var emailAddress = document.register.txtUserName.value;
			...
			if (document.register.txtUserName.value == "") {
				...
				document.register.txtUserName.focus();
				return false;
			}else if((idx > -1 && emailAddress.slice(idx) != '.edu')&&
					(idx > -1 && emailAddress.slice(idx) != '.gov')) {
				// false if the address does not end with .edu or .gov
				  alert("Please enter username with .edu or .gov as the domain name");
				return false;
			}
			return true;
		}
	...
	<form name="register" method="post" action="RegServlet">
		<table style="height: 600px; background-color: #10B7C6;"
			...
			String registrationUsernameError = (String) session
					.getAttribute("registrationUsernameErr");
		...
		%>
			<tr>
				<td align="left" style="padding-left: 600px" valign="bottom"><b><font
						color="black" style="font-family: fantasy;">EmailID</font></b></td>
			...
			<tr style="height: 50px">
				<td align="left" style="padding-left: 600px" valign="center"><b><font
						color="black" style="font-family: fantasy;">Password</font></b></td>
			...
			<tr style="height: 40px">
				<td align="left" style="padding-left: 600px" valign="top"><b><font
						color="black" style="font-family: fantasy;">First name</font></b></td>
			...
			<tr style="height: 50px">
				<td align="left" style="padding-left: 600px" valign="top"><b><font
						color="black" style="font-family: fantasy;">Last name</font></b></td>
				<td align="left" style="padding-right: 600px" valign="top">
		...
		if(registrationUsernameError!=null && registrationUsernameError.equals("registrationUsernameErr")){%>
		<div style="color: red">Please enter username with edu or gov as
			domain extension!!</div>
		<%	
		}
		session.removeAttribute("duplicate");
		session.removeAttribute("registrationErr");
		session.removeAttribute("registrationUsernameErr");
